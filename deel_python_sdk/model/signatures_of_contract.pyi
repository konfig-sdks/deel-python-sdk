...
class SignaturesOfContract(
    ...
    class MetaOapg:
        ...
        class properties:
            client_signature = schemas.StrSchema
            ...
            @staticmethod
            def signed_at() -> typing.Type['DateTimeString']:
                return DateTimeString
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["signed_at"]) -> 'DateTimeString': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["client_signature", "client_signed_at", "worker_signature", "worker_signed_at", "signed_at", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["signed_at"]) -> 'DateTimeString': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["client_signature", "client_signed_at", "worker_signature", "worker_signed_at", "signed_at", ], str]):
