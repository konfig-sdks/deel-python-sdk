...
class InvoiceAdjustmentCreated(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created", "id", "status", "created_at", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> typing.Union['InvoiceAdjustmentStatusEnum', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created", "id", "status", "created_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        status: typing.Union['InvoiceAdjustmentStatusEnum', schemas.Unset] = schemas.unset,
