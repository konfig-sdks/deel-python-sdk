...
class ContractDocumentContainer(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['FileAttachmentInfo']:
                return FileAttachmentInfo
            __annotations__ = {
                "data": data,
            }
    
    data: 'FileAttachmentInfo'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'FileAttachmentInfo': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'FileAttachmentInfo': ...
