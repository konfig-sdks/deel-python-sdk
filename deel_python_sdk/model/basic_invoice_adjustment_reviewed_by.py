...
class BasicInvoiceAdjustmentReviewedBy(
    schemas.DictBase,
    schemas.NoneBase,
    schemas.Schema,
    ...
    remarks: MetaOapg.properties.remarks
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "full_name", "reviewed_at", "remarks", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["remarks"]) -> MetaOapg.properties.remarks: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "full_name", "reviewed_at", "remarks", ], str]):
