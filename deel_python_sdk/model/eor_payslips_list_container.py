...
class EORPayslipsListContainer(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Payslips']:
                        return Payslips
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Payslips'], typing.List['Payslips']],
                ...
                def __getitem__(self, i: int) -> 'Payslips':
