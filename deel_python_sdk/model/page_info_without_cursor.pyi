...
class PageInfoWithoutCursor(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total_rows", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total_rows", ], str]):
