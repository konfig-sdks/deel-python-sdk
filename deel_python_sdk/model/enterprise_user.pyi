...
class EnterpriseUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["department", "costCenter", "organization", "manager", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["department", "costCenter", "organization", "manager", ], str]):
