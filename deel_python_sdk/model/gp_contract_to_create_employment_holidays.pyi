...
class GPContractToCreateEmploymentHolidays(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["allowance", "start_date", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["allowance", "start_date", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        allowance: typing.Union[MetaOapg.properties.allowance, decimal.Decimal, int, float, ],
        start_date: 'DateStringRequired',
