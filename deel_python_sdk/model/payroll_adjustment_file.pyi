...
class PayrollAdjustmentFile(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "fileType", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "fileType", ], str]):
