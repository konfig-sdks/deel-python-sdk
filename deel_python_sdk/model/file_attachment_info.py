...
class FileAttachmentInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["filename", "key", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["filename", "key", ], str]):
