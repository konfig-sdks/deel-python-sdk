...
class BankGuideValidations(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["regex", "minLength", "maxLength", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["regex", "minLength", "maxLength", ], str]):
