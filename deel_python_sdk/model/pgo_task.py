...
class PgoTask(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "id", "amount", "date_submitted", "status", "attachment", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "id", "amount", "date_submitted", "status", "attachment", ], str]):
