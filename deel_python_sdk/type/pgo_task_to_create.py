...
class RequiredPgoTaskToCreate(TypedDict):
    # Task description.
...
class OptionalPgoTaskToCreate(TypedDict, total=False):
    attachment: typing.Optional[FileAttachmentInfo]

class PgoTaskToCreate(RequiredPgoTaskToCreate, OptionalPgoTaskToCreate):
    pass
