...
class RequiredSignaturesOfContract(TypedDict):
...
class OptionalSignaturesOfContract(TypedDict, total=False):
    pass

class SignaturesOfContract(RequiredSignaturesOfContract, OptionalSignaturesOfContract):
    pass
