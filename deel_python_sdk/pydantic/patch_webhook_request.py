...
from deel_python_sdk.pydantic.patch_webhook_request_events import PatchWebhookRequestEvents
...
class PatchWebhookRequest(BaseModel):
    ...
    events: PatchWebhookRequestEvents = Field(alias='events')

    # Deel API version. Currently Deel accepts v1 or v2 version.
    api_version: typing.Optional[str] = Field(None, alias='api_version')
