...
from deel_python_sdk.model.working_locations_container import WorkingLocationsContainer as WorkingLocationsContainerSchema

from deel_python_sdk.type.working_locations_container import WorkingLocationsContainer
from deel_python_sdk.type.api_error_container import ApiErrorContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.working_locations_container import WorkingLocationsContainer as WorkingLocationsContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = WorkingLocationsContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkingLocationsContainer
...
class BaseApi(api_client.Api):
    ...
    def _get_working_locations_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_working_locations_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/working-locations',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_working_locations_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class GetWorkingLocationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_working_locations(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_working_locations_mapped_args(
        )
        return await self._aget_working_locations_oapg(
            **kwargs,
        )
    ...
    def get_working_locations(
        ...
        return self._get_working_locations_oapg(
        )

class GetWorkingLocations(BaseApi):

    async def aget_working_locations(
        self,
        validate: bool = False,
        **kwargs,
    ) -> WorkingLocationsContainerPydantic:
        raw_response = await self.raw.aget_working_locations(
            **kwargs,
        )
        if validate:
            return WorkingLocationsContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkingLocationsContainerPydantic, raw_response.body)
    ...
    def get_working_locations(
        ...
        raw_response = self.raw.get_working_locations(
        )
        if validate:
            return WorkingLocationsContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkingLocationsContainerPydantic, raw_response.body)
