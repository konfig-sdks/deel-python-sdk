...
from deel_python_sdk.model.team_list_container import TeamListContainer as TeamListContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.team_list_container import TeamListContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.team_list_container import TeamListContainer as TeamListContainerPydantic
from deel_python_sdk.pydantic.api_error_container import ApiErrorContainer as ApiErrorContainerPydantic

SchemaFor200ResponseBodyApplicationJson = TeamListContainerSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_team_list_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_team_list_oapg(
        self,
...
class GetTeamListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_team_list(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_team_list_mapped_args(
        )
        return await self._aget_team_list_oapg(
            **kwargs,
        )
    ...
    def get_team_list(
        ...
        return self._get_team_list_oapg(
        )

class GetTeamList(BaseApi):

    async def aget_team_list(
        self,
        validate: bool = False,
        **kwargs,
    ) -> TeamListContainerPydantic:
        raw_response = await self.raw.aget_team_list(
            **kwargs,
        )
        if validate:
            return TeamListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(TeamListContainerPydantic, raw_response.body)
    ...
    def get_team_list(
        ...
        raw_response = self.raw.get_team_list(
        )
        if validate:
            return TeamListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(TeamListContainerPydantic, raw_response.body)
