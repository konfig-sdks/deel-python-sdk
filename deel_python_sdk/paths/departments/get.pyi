...
from deel_python_sdk.model.departments_container import DepartmentsContainer as DepartmentsContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.departments_container import DepartmentsContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.departments_container import DepartmentsContainer as DepartmentsContainerPydantic
from deel_python_sdk.pydantic.api_error_container import ApiErrorContainer as ApiErrorContainerPydantic

SchemaFor200ResponseBodyApplicationJson = DepartmentsContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DepartmentsContainer
...
class BaseApi(api_client.Api):
    ...
    def _get_department_list_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_department_list_oapg(
        self,
...
class GetDepartmentListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_department_list(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_department_list_mapped_args(
        )
        return await self._aget_department_list_oapg(
            **kwargs,
        )
    ...
    def get_department_list(
        ...
        return self._get_department_list_oapg(
        )

class GetDepartmentList(BaseApi):

    async def aget_department_list(
        self,
        validate: bool = False,
        **kwargs,
    ) -> DepartmentsContainerPydantic:
        raw_response = await self.raw.aget_department_list(
            **kwargs,
        )
        if validate:
            return DepartmentsContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(DepartmentsContainerPydantic, raw_response.body)
    ...
    def get_department_list(
        ...
        raw_response = self.raw.get_department_list(
        )
        if validate:
            return DepartmentsContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(DepartmentsContainerPydantic, raw_response.body)
