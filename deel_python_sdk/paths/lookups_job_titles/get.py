...
from deel_python_sdk.model.job_title_list_container import JobTitleListContainer as JobTitleListContainerSchema

from deel_python_sdk.type.job_title_list_container import JobTitleListContainer
from deel_python_sdk.type.api_error_container import ApiErrorContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.job_title_list_container import JobTitleListContainer as JobTitleListContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = JobTitleListContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobTitleListContainer
...
class BaseApi(api_client.Api):
    ...
    def _get_job_titles_list_mapped_args(
        self,
    ...
    async def _aget_job_titles_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lookups/job-titles',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetJobTitlesListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_job_titles_list(
        self,
        limit: typing.Optional[typing.Union[int, float]] = None,
        after_cursor: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_job_titles_list_mapped_args(
            limit=limit,
            after_cursor=after_cursor,
        )
        return await self._aget_job_titles_list_oapg(
    ...
    def get_job_titles_list(
        ...
        return self._get_job_titles_list_oapg(
            query_params=args.query,
        )

class GetJobTitlesList(BaseApi):
    ...
    async def aget_job_titles_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobTitleListContainerPydantic:
        raw_response = await self.raw.aget_job_titles_list(
            limit=limit,
            after_cursor=after_cursor,
            **kwargs,
        )
        if validate:
            return JobTitleListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(JobTitleListContainerPydantic, raw_response.body)
    ...
    def get_job_titles_list(
        ...
        raw_response = self.raw.get_job_titles_list(
            limit=limit,
            after_cursor=after_cursor,
        )
        if validate:
