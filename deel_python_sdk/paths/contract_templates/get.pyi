...
from deel_python_sdk.model.contract_template_list_container import ContractTemplateListContainer as ContractTemplateListContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.contract_template_list_container import ContractTemplateListContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.contract_template_list_container import ContractTemplateListContainer as ContractTemplateListContainerPydantic
from deel_python_sdk.pydantic.api_error_container import ApiErrorContainer as ApiErrorContainerPydantic

SchemaFor200ResponseBodyApplicationJson = ContractTemplateListContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ContractTemplateListContainer
    ...
    async def _aget_list_0_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/contract-templates',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetList0(BaseApi):
    ...
    async def aget_list_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContractTemplateListContainerPydantic:
        raw_response = await self.raw.aget_list_0(
            **kwargs,
        )
        if validate:
            return ContractTemplateListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(ContractTemplateListContainerPydantic, raw_response.body)
