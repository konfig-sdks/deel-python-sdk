...
from deel_python_sdk.model.employee_agreement_download_container import EmployeeAgreementDownloadContainer as EmployeeAgreementDownloadContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.employee_agreement_download_container import EmployeeAgreementDownloadContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.employee_agreement_download_container import EmployeeAgreementDownloadContainer as EmployeeAgreementDownloadContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = EmployeeAgreementDownloadContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeeAgreementDownloadContainer
...
class BaseApi(api_client.Api):
    ...
    def _download_hr_verification_letters_and_documents_mapped_args(
        self,
        employee_id: str,
        contract_id: str,
    ...
    async def _adownload_hr_verification_letters_and_documents_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/partner-managed/employees/{employee_id}/contracts/{contract_id}/hr-documents/{document_id}/download',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _download_hr_verification_letters_and_documents_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DownloadHrVerificationLettersAndDocumentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adownload_hr_verification_letters_and_documents(
        self,
        employee_id: str,
        contract_id: str,
        document_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._download_hr_verification_letters_and_documents_mapped_args(
            employee_id=employee_id,
            contract_id=contract_id,
            document_id=document_id,
        )
        return await self._adownload_hr_verification_letters_and_documents_oapg(
    ...
    def download_hr_verification_letters_and_documents(
        ...
        return self._download_hr_verification_letters_and_documents_oapg(
            path_params=args.path,
        )

class DownloadHrVerificationLettersAndDocuments(BaseApi):
    ...
    async def adownload_hr_verification_letters_and_documents(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeeAgreementDownloadContainerPydantic:
        raw_response = await self.raw.adownload_hr_verification_letters_and_documents(
            employee_id=employee_id,
            contract_id=contract_id,
            document_id=document_id,
            **kwargs,
        ...
        if validate:
            return EmployeeAgreementDownloadContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeeAgreementDownloadContainerPydantic, raw_response.body)
    ...
    def download_hr_verification_letters_and_documents(
        ...
        raw_response = self.raw.download_hr_verification_letters_and_documents(
            employee_id=employee_id,
            contract_id=contract_id,
            document_id=document_id,
        )
