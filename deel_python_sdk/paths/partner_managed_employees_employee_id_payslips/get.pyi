...
from deel_python_sdk.model.employee_payslips_list_container import EmployeePayslipsListContainer as EmployeePayslipsListContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.employee_payslips_list_container import EmployeePayslipsListContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.employee_payslips_list_container import EmployeePayslipsListContainer as EmployeePayslipsListContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = EmployeePayslipsListContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeePayslipsListContainer
...
class BaseApi(api_client.Api):
    ...
    def _list_payslips_for_eor_employee_mapped_args(
        self,
        employee_id: str,
    ...
    async def _alist_payslips_for_eor_employee_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/partner-managed/employees/{employee_id}/payslips',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_payslips_for_eor_employee_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListPayslipsForEorEmployeeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_payslips_for_eor_employee(
        self,
        employee_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_payslips_for_eor_employee_mapped_args(
            employee_id=employee_id,
        )
        return await self._alist_payslips_for_eor_employee_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_payslips_for_eor_employee(
        self,
        employee_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._list_payslips_for_eor_employee_oapg(
            path_params=args.path,
        )

class ListPayslipsForEorEmployee(BaseApi):
    ...
    async def alist_payslips_for_eor_employee(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeePayslipsListContainerPydantic:
        raw_response = await self.raw.alist_payslips_for_eor_employee(
            employee_id=employee_id,
            **kwargs,
        )
        if validate:
            return EmployeePayslipsListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeePayslipsListContainerPydantic, raw_response.body)
    ...
    def list_payslips_for_eor_employee(
        ...
        raw_response = self.raw.list_payslips_for_eor_employee(
            employee_id=employee_id,
        )
        if validate:
            return EmployeePayslipsListContainerPydantic(**raw_response.body)
