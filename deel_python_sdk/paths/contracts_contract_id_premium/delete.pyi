...
class BaseApi(api_client.Api):
    ...
    def _remove_premium_mapped_args(
        self,
        contract_id: str,
    ...
    async def _aremove_premium_oapg(
        self,
...
class RemovePremiumRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_premium(
        self,
        contract_id: str,
        reason: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._remove_premium_mapped_args(
            contract_id=contract_id,
            reason=reason,
        )
        return await self._aremove_premium_oapg(
    ...
    def remove_premium(
        ...
        return self._remove_premium_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class RemovePremium(BaseApi):
    ...
    async def aremove_premium(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_premium(
            contract_id=contract_id,
            reason=reason,
            **kwargs,
        )
    ...
    def remove_premium(
        ...
        raw_response = self.raw.remove_premium(
            contract_id=contract_id,
            reason=reason,
        )
        if validate:
