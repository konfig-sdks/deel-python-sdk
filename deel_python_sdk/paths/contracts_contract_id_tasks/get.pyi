...
SchemaFor200ResponseBodyApplicationJson = TaskListContainerSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_contract_tasks_mapped_args(
        self,
        contract_id: str,
    ...
    async def _aget_contract_tasks_oapg(
        self,
...
class GetContractTasksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_contract_tasks(
        self,
        contract_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_contract_tasks_mapped_args(
            contract_id=contract_id,
        )
        return await self._aget_contract_tasks_oapg(
    ...
    def get_contract_tasks(
        ...
        return self._get_contract_tasks_oapg(
            path_params=args.path,
        )

class GetContractTasks(BaseApi):
    ...
    async def aget_contract_tasks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_contract_tasks(
            contract_id=contract_id,
            **kwargs,
        )
        if validate:
    ...
    def get_contract_tasks(
        ...
        raw_response = self.raw.get_contract_tasks(
            contract_id=contract_id,
        )
        if validate:
            return TaskListContainerPydantic(**raw_response.body)
