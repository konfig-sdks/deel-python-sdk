...
from deel_python_sdk.model.input_to_create_pgo_task import InputToCreatePgoTask as InputToCreatePgoTaskSchema
from deel_python_sdk.model.pgo_task_to_create import PgoTaskToCreate as PgoTaskToCreateSchema
from deel_python_sdk.model.task_created_container import TaskCreatedContainer as TaskCreatedContainerSchema

from deel_python_sdk.type.input_to_create_pgo_task import InputToCreatePgoTask
from deel_python_sdk.type.pgo_task_to_create import PgoTaskToCreate
from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.task_created_container import TaskCreatedContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.input_to_create_pgo_task import InputToCreatePgoTask as InputToCreatePgoTaskPydantic
from deel_python_sdk.pydantic.task_created_container import TaskCreatedContainer as TaskCreatedContainerPydantic
from deel_python_sdk.pydantic.pgo_task_to_create import PgoTaskToCreate as PgoTaskToCreatePydantic
...
# body param
SchemaForRequestBodyApplicationJson = InputToCreatePgoTaskSchema


request_body_input_to_create_pgo_task = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = TaskCreatedContainerSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: TaskCreatedContainer
    ...
    async def _acreate_new_task_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/contracts/{contract_id}/tasks',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_input_to_create_pgo_task.serialize(body, content_type)
...
class CreateNewTask(BaseApi):
    ...
    async def acreate_new_task(
        ...
        **kwargs,
        ...
        if validate:
            return TaskCreatedContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(TaskCreatedContainerPydantic, raw_response.body)
