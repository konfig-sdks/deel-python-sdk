...
from deel_python_sdk.model.timeoff_to_review_container import TimeoffToReviewContainer as TimeoffToReviewContainerSchema
from deel_python_sdk.model.generic_result_updated import GenericResultUpdated as GenericResultUpdatedSchema
from deel_python_sdk.model.timeoff_review import TimeoffReview as TimeoffReviewSchema
...
from deel_python_sdk.type.timeoff_to_review_container import TimeoffToReviewContainer
from deel_python_sdk.type.timeoff_review import TimeoffReview

from ...api_client import Dictionary
from deel_python_sdk.pydantic.timeoff_review import TimeoffReview as TimeoffReviewPydantic
from deel_python_sdk.pydantic.timeoff_to_review_container import TimeoffToReviewContainer as TimeoffToReviewContainerPydantic
...
# body param
SchemaForRequestBodyApplicationJson = TimeoffToReviewContainerSchema


request_body_timeoff_to_review_container = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _manage_request_mapped_args(
        self,
        data: TimeoffReview,
        timeoff_id: str,
    ...
    async def _amanage_request_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/time-offs/{timeoff_id}/review',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_timeoff_to_review_container.serialize(body, content_type)
...
class ManageRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amanage_request(
        self,
        data: TimeoffReview,
        timeoff_id: str,
        **kwargs,
        ...
        args = self._manage_request_mapped_args(
            data=data,
            timeoff_id=timeoff_id,
        )
        return await self._amanage_request_oapg(
            body=args.body,
    ...
    def manage_request(
        ...
        return self._manage_request_oapg(
            body=args.body,
            path_params=args.path,
        )

class ManageRequest(BaseApi):
    ...
    async def amanage_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amanage_request(
            data=data,
            timeoff_id=timeoff_id,
            **kwargs,
        )
    ...
    def manage_request(
        ...
        raw_response = self.raw.manage_request(
            data=data,
            timeoff_id=timeoff_id,
        )
        if validate:
