...
from deel_python_sdk.model.people_by_id_container import PeopleByIdContainer as PeopleByIdContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.people_by_id_container import PeopleByIdContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.people_by_id_container import PeopleByIdContainer as PeopleByIdContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = PeopleByIdContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PeopleByIdContainer
    ...
    async def _aget_person_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{worker_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetPersonRaw(BaseApi):
    ...
    async def aget_person(
        ...
        **kwargs,
        ...
        args = self._get_person_mapped_args(
            worker_id=worker_id,
        )
        return await self._aget_person_oapg(
...
class GetPerson(BaseApi):
    ...
    async def aget_person(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PeopleByIdContainerPydantic:
        raw_response = await self.raw.aget_person(
            worker_id=worker_id,
            **kwargs,
        )
        if validate:
            return PeopleByIdContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(PeopleByIdContainerPydantic, raw_response.body)
    ...
    def get_person(
        ...
        raw_response = self.raw.get_person(
            worker_id=worker_id,
        )
        if validate:
            return PeopleByIdContainerPydantic(**raw_response.body)
