...
from deel_python_sdk.model.timesheet_container import TimesheetContainer as TimesheetContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.timesheet_container import TimesheetContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.timesheet_container import TimesheetContainer as TimesheetContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = TimesheetContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TimesheetContainer
...
class BaseApi(api_client.Api):
    ...
    def _get_single_entry_mapped_args(
        self,
    ...
    async def _aget_single_entry_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/timesheets/{timesheet_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetSingleEntryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single_entry(
        self,
        timesheet_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_single_entry_mapped_args(
            timesheet_id=timesheet_id,
        )
        return await self._aget_single_entry_oapg(
    ...
    def get_single_entry(
        ...
        return self._get_single_entry_oapg(
            path_params=args.path,
        )

class GetSingleEntry(BaseApi):
    ...
    async def aget_single_entry(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimesheetContainerPydantic:
        raw_response = await self.raw.aget_single_entry(
            timesheet_id=timesheet_id,
            **kwargs,
        )
        if validate:
            return TimesheetContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(TimesheetContainerPydantic, raw_response.body)
    ...
    def get_single_entry(
        ...
        raw_response = self.raw.get_single_entry(
            timesheet_id=timesheet_id,
        )
        if validate:
            return TimesheetContainerPydantic(**raw_response.body)
