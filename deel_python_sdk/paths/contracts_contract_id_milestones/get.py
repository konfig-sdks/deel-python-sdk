...
from deel_python_sdk.model.milestone_list_container import MilestoneListContainer as MilestoneListContainerSchema
...
from deel_python_sdk.type.milestone_list_container import MilestoneListContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.milestone_list_container import MilestoneListContainer as MilestoneListContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = MilestoneListContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MilestoneListContainer
...
class ListByContract(BaseApi):
    ...
    async def alist_by_contract(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MilestoneListContainerPydantic:
        raw_response = await self.raw.alist_by_contract(
            contract_id=contract_id,
            **kwargs,
        )
        if validate:
            return MilestoneListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(MilestoneListContainerPydantic, raw_response.body)
