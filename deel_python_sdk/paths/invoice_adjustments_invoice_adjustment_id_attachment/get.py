...
from deel_python_sdk.model.invoice_adjustment_attachment_container import InvoiceAdjustmentAttachmentContainer as InvoiceAdjustmentAttachmentContainerSchema

from deel_python_sdk.type.invoice_adjustment_attachment_container import InvoiceAdjustmentAttachmentContainer
from deel_python_sdk.type.api_error_container import ApiErrorContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.invoice_adjustment_attachment_container import InvoiceAdjustmentAttachmentContainer as InvoiceAdjustmentAttachmentContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = InvoiceAdjustmentAttachmentContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: InvoiceAdjustmentAttachmentContainer
...
class BaseApi(api_client.Api):
    ...
    def _get_attachment_file_url_mapped_args(
        self,
    ...
    async def _aget_attachment_file_url_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/invoice-adjustments/{invoice_adjustment_id}/attachment',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_attachment_file_url_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAttachmentFileUrlRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_attachment_file_url(
        self,
        invoice_adjustment_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_attachment_file_url_mapped_args(
            invoice_adjustment_id=invoice_adjustment_id,
        )
        return await self._aget_attachment_file_url_oapg(
    ...
    def get_attachment_file_url(
        ...
        return self._get_attachment_file_url_oapg(
            path_params=args.path,
        )

class GetAttachmentFileUrl(BaseApi):
    ...
    async def aget_attachment_file_url(
        ...
        validate: bool = False,
        **kwargs,
    ) -> InvoiceAdjustmentAttachmentContainerPydantic:
        raw_response = await self.raw.aget_attachment_file_url(
            invoice_adjustment_id=invoice_adjustment_id,
            **kwargs,
        )
        if validate:
            return InvoiceAdjustmentAttachmentContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(InvoiceAdjustmentAttachmentContainerPydantic, raw_response.body)
    ...
    def get_attachment_file_url(
        ...
        raw_response = self.raw.get_attachment_file_url(
            invoice_adjustment_id=invoice_adjustment_id,
        )
        if validate:
            return InvoiceAdjustmentAttachmentContainerPydantic(**raw_response.body)
