...
from deel_python_sdk.model.employee_tax_documents_list_container import EmployeeTaxDocumentsListContainer as EmployeeTaxDocumentsListContainerSchema

from deel_python_sdk.type.employee_tax_documents_list_container import EmployeeTaxDocumentsListContainer
from deel_python_sdk.type.api_error_container import ApiErrorContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.employee_tax_documents_list_container import EmployeeTaxDocumentsListContainer as EmployeeTaxDocumentsListContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = EmployeeTaxDocumentsListContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeeTaxDocumentsListContainer
...
class BaseApi(api_client.Api):
    ...
    def _list_tax_documents_for_employee_mapped_args(
        self,
        employee_id: str,
    ...
    async def _alist_tax_documents_for_employee_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/partner-managed/employees/{employee_id}/tax-documents',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_tax_documents_for_employee_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListTaxDocumentsForEmployeeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_tax_documents_for_employee(
        self,
        employee_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_tax_documents_for_employee_mapped_args(
            employee_id=employee_id,
        )
        return await self._alist_tax_documents_for_employee_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_tax_documents_for_employee(
        self,
        employee_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._list_tax_documents_for_employee_oapg(
            path_params=args.path,
        )

class ListTaxDocumentsForEmployee(BaseApi):
    ...
    async def alist_tax_documents_for_employee(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeeTaxDocumentsListContainerPydantic:
        raw_response = await self.raw.alist_tax_documents_for_employee(
            employee_id=employee_id,
            **kwargs,
        )
        if validate:
            return EmployeeTaxDocumentsListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeeTaxDocumentsListContainerPydantic, raw_response.body)
    ...
    def list_tax_documents_for_employee(
        ...
        raw_response = self.raw.list_tax_documents_for_employee(
            employee_id=employee_id,
        )
        if validate:
            return EmployeeTaxDocumentsListContainerPydantic(**raw_response.body)
