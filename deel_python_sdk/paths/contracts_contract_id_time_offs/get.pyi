...
from deel_python_sdk.model.eor_timeoffs_container import EorTimeoffsContainer as EorTimeoffsContainerSchema
from deel_python_sdk.model.api_error_container import ApiErrorContainer as ApiErrorContainerSchema

from deel_python_sdk.type.eor_timeoffs_container import EorTimeoffsContainer
from deel_python_sdk.type.api_error_container import ApiErrorContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.eor_timeoffs_container import EorTimeoffsContainer as EorTimeoffsContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = EorTimeoffsContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EorTimeoffsContainer
...
class ListByContract(BaseApi):
    ...
    async def alist_by_contract(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EorTimeoffsContainerPydantic:
        raw_response = await self.raw.alist_by_contract(
            contract_id=contract_id,
            **kwargs,
        )
        if validate:
            return EorTimeoffsContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(EorTimeoffsContainerPydantic, raw_response.body)
