...
class BaseApi(api_client.Api):
    ...
    def _remove_adjustment_mapped_args(
        self,
        adjustment_id: str,
    ...
    async def _aremove_adjustment_oapg(
        self,
...
class RemoveAdjustmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_adjustment(
        self,
        adjustment_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_adjustment_mapped_args(
            adjustment_id=adjustment_id,
        )
        return await self._aremove_adjustment_oapg(
    ...
    def remove_adjustment(
        ...
        return self._remove_adjustment_oapg(
            path_params=args.path,
        )

class RemoveAdjustment(BaseApi):
    ...
    async def aremove_adjustment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_adjustment(
            adjustment_id=adjustment_id,
            **kwargs,
        )
        if validate:
    ...
    def remove_adjustment(
        ...
        raw_response = self.raw.remove_adjustment(
            adjustment_id=adjustment_id,
        )
        if validate:
            return GenericResultDeletedPydantic(**raw_response.body)
