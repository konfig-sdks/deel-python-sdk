...
class BaseApi(api_client.Api):
    ...
    def _remove_invite_mapped_args(
        self,
        contract_id: str,
    ...
    async def _aremove_invite_oapg(
        self,
...
class RemoveInviteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_invite(
        self,
        contract_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_invite_mapped_args(
            contract_id=contract_id,
        )
        return await self._aremove_invite_oapg(
    ...
    def remove_invite(
        ...
        return self._remove_invite_oapg(
            path_params=args.path,
        )

class RemoveInvite(BaseApi):
    ...
    async def aremove_invite(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_invite(
            contract_id=contract_id,
            **kwargs,
        )
        if validate:
    ...
    def remove_invite(
        ...
        raw_response = self.raw.remove_invite(
            contract_id=contract_id,
        )
        if validate:
            return GenericResultDeletedPydantic(**raw_response.body)
