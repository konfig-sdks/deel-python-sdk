...
from deel_python_sdk.model.off_cycle_payment_list_container import OffCyclePaymentListContainer as OffCyclePaymentListContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.off_cycle_payment_list_container import OffCyclePaymentListContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.off_cycle_payment_list_container import OffCyclePaymentListContainer as OffCyclePaymentListContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = OffCyclePaymentListContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OffCyclePaymentListContainer
...
class GetList(BaseApi):
    ...
    async def aget_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OffCyclePaymentListContainerPydantic:
        raw_response = await self.raw.aget_list(
            contract_id=contract_id,
            **kwargs,
        )
        if validate:
            return OffCyclePaymentListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(OffCyclePaymentListContainerPydantic, raw_response.body)
