...
from deel_python_sdk.model.candidate_to_patch_container import CandidateToPatchContainer as CandidateToPatchContainerSchema
from deel_python_sdk.model.generic_result_updated import GenericResultUpdated as GenericResultUpdatedSchema
from deel_python_sdk.model.candidate_to_patch import CandidateToPatch as CandidateToPatchSchema

from deel_python_sdk.type.generic_result_updated import GenericResultUpdated
from deel_python_sdk.type.candidate_to_patch import CandidateToPatch
from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.candidate_to_patch_container import CandidateToPatchContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.candidate_to_patch_container import CandidateToPatchContainer as CandidateToPatchContainerPydantic
...
from deel_python_sdk.pydantic.candidate_to_patch import CandidateToPatch as CandidateToPatchPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'candidate_id': typing.Union[CandidateIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = CandidateToPatchContainerSchema


request_body_candidate_to_patch_container = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_candidate_by_id_mapped_args(
        self,
    ...
    async def _aupdate_candidate_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_candidate_to_patch_container.serialize(body, content_type)
    ...
    def _update_candidate_by_id_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateCandidateByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_candidate_by_id(
        self,
        data: CandidateToPatch,
        candidate_id: str,
        **kwargs,
        ...
        args = self._update_candidate_by_id_mapped_args(
            data=data,
            candidate_id=candidate_id,
        )
        return await self._aupdate_candidate_by_id_oapg(
            body=args.body,
    ...
    def update_candidate_by_id(
        ...
        return self._update_candidate_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateCandidateById(BaseApi):
    ...
    async def aupdate_candidate_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_candidate_by_id(
            data=data,
            candidate_id=candidate_id,
            **kwargs,
        )
    ...
    def update_candidate_by_id(
        ...
        raw_response = self.raw.update_candidate_by_id(
            data=data,
            candidate_id=candidate_id,
        )
        if validate:
