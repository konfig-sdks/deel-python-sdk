...
from deel_python_sdk.model.webhook_event_type_list_response import WebhookEventTypeListResponse as WebhookEventTypeListResponseSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.webhook_event_type_list_response import WebhookEventTypeListResponse

from ...api_client import Dictionary
from deel_python_sdk.pydantic.webhook_event_type_list_response import WebhookEventTypeListResponse as WebhookEventTypeListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WebhookEventTypeListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WebhookEventTypeListResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_event_types_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_event_types_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/webhooks/events/types',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListEventTypesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_event_types(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_event_types_mapped_args(
        )
        return await self._alist_event_types_oapg(
            **kwargs,
        )
    ...
    def list_event_types(
        ...
        return self._list_event_types_oapg(
        )

class ListEventTypes(BaseApi):

    async def alist_event_types(
        self,
        validate: bool = False,
        **kwargs,
    ) -> WebhookEventTypeListResponsePydantic:
        raw_response = await self.raw.alist_event_types(
            **kwargs,
        )
        if validate:
            return WebhookEventTypeListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhookEventTypeListResponsePydantic, raw_response.body)
    ...
    def list_event_types(
        ...
        raw_response = self.raw.list_event_types(
        )
        if validate:
            return WebhookEventTypeListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhookEventTypeListResponsePydantic, raw_response.body)
