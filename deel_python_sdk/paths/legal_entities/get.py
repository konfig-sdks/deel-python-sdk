...
from deel_python_sdk.model.legal_entity_list_container import LegalEntityListContainer as LegalEntityListContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.legal_entity_list_container import LegalEntityListContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.legal_entity_list_container import LegalEntityListContainer as LegalEntityListContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = LegalEntityListContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LegalEntityListContainer
...
class BaseApi(api_client.Api):
    ...
    def _get_legal_entities_list_mapped_args(
        self,
    ...
    async def _aget_legal_entities_list_oapg(
        self,
    ...
    def _get_legal_entities_list_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetLegalEntitiesListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_legal_entities_list(
        self,
        type: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_legal_entities_list_mapped_args(
            type=type,
        )
        return await self._aget_legal_entities_list_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_legal_entities_list(
        self,
        type: typing.Optional[str] = None,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_legal_entities_list_oapg(
            query_params=args.query,
        )

class GetLegalEntitiesList(BaseApi):
    ...
    async def aget_legal_entities_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LegalEntityListContainerPydantic:
        raw_response = await self.raw.aget_legal_entities_list(
            type=type,
            **kwargs,
        )
        if validate:
            return LegalEntityListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(LegalEntityListContainerPydantic, raw_response.body)
    ...
    def get_legal_entities_list(
        ...
        raw_response = self.raw.get_legal_entities_list(
            type=type,
        )
        if validate:
            return LegalEntityListContainerPydantic(**raw_response.body)
