...
from deel_python_sdk.model.seniority_list_container import SeniorityListContainer as SeniorityListContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.seniority_list_container import SeniorityListContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.seniority_list_container import SeniorityListContainer as SeniorityListContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = SeniorityListContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SeniorityListContainer
...
class BaseApi(api_client.Api):
    ...
    def _get_seniority_levels_mapped_args(
        self,
    ...
    async def _aget_seniority_levels_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lookups/seniorities',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_seniority_levels_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSeniorityLevelsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_seniority_levels(
        self,
        limit: typing.Optional[typing.Union[int, float]] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_seniority_levels_mapped_args(
            limit=limit,
        )
        return await self._aget_seniority_levels_oapg(
    ...
    def get_seniority_levels(
        ...
        return self._get_seniority_levels_oapg(
            query_params=args.query,
        )

class GetSeniorityLevels(BaseApi):
    ...
    async def aget_seniority_levels(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SeniorityListContainerPydantic:
        raw_response = await self.raw.aget_seniority_levels(
            limit=limit,
            **kwargs,
        )
        if validate:
            return SeniorityListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(SeniorityListContainerPydantic, raw_response.body)
    ...
    def get_seniority_levels(
        ...
        raw_response = self.raw.get_seniority_levels(
            limit=limit,
        )
        if validate:
            return SeniorityListContainerPydantic(**raw_response.body)
