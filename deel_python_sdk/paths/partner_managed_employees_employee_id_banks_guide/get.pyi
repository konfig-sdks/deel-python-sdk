...
from deel_python_sdk.model.bank_account_guide_container import BankAccountGuideContainer as BankAccountGuideContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.bank_account_guide_container import BankAccountGuideContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.bank_account_guide_container import BankAccountGuideContainer as BankAccountGuideContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = BankAccountGuideContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BankAccountGuideContainer
...
class BaseApi(api_client.Api):
    ...
    def _get_bank_guide_for_eor_employee_mapped_args(
        self,
        employee_id: str,
    ...
    async def _aget_bank_guide_for_eor_employee_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/partner-managed/employees/{employee_id}/banks/guide',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_bank_guide_for_eor_employee_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetBankGuideForEorEmployeeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_bank_guide_for_eor_employee(
        self,
        employee_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_bank_guide_for_eor_employee_mapped_args(
            employee_id=employee_id,
        )
        return await self._aget_bank_guide_for_eor_employee_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_bank_guide_for_eor_employee(
        self,
        employee_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_bank_guide_for_eor_employee_oapg(
            path_params=args.path,
        )

class GetBankGuideForEorEmployee(BaseApi):
    ...
    async def aget_bank_guide_for_eor_employee(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BankAccountGuideContainerPydantic:
        raw_response = await self.raw.aget_bank_guide_for_eor_employee(
            employee_id=employee_id,
            **kwargs,
        )
        if validate:
            return BankAccountGuideContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(BankAccountGuideContainerPydantic, raw_response.body)
    ...
    def get_bank_guide_for_eor_employee(
        ...
        raw_response = self.raw.get_bank_guide_for_eor_employee(
            employee_id=employee_id,
        )
        if validate:
            return BankAccountGuideContainerPydantic(**raw_response.body)
