...
from deel_python_sdk.model.agreement_list_container import AgreementListContainer as AgreementListContainerSchema

from deel_python_sdk.type.agreement_list_container import AgreementListContainer
from deel_python_sdk.type.api_error_container import ApiErrorContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.agreement_list_container import AgreementListContainer as AgreementListContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = AgreementListContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AgreementListContainer
...
class BaseApi(api_client.Api):
    ...
    def _list_agreements_with_deel_mapped_args(
        self,
    ...
    async def _alist_agreements_with_deel_oapg(
        self,
    ...
    def _list_agreements_with_deel_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListAgreementsWithDeelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_agreements_with_deel(
        self,
        contract_id: typing.Optional[str] = None,
        limit: typing.Optional[str] = None,
        offset: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_agreements_with_deel_mapped_args(
            contract_id=contract_id,
            limit=limit,
            offset=offset,
        )
        return await self._alist_agreements_with_deel_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_agreements_with_deel(
        self,
        contract_id: typing.Optional[str] = None,
        limit: typing.Optional[str] = None,
        offset: typing.Optional[str] = None,
        ...
        return self._list_agreements_with_deel_oapg(
            query_params=args.query,
        )

class ListAgreementsWithDeel(BaseApi):
    ...
    async def alist_agreements_with_deel(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AgreementListContainerPydantic:
        raw_response = await self.raw.alist_agreements_with_deel(
            contract_id=contract_id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return AgreementListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(AgreementListContainerPydantic, raw_response.body)
    ...
    def list_agreements_with_deel(
        ...
        raw_response = self.raw.list_agreements_with_deel(
            contract_id=contract_id,
            limit=limit,
            offset=offset,
        )
