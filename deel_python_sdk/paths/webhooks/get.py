...
from deel_python_sdk.model.webhook_list_response import WebhookListResponse as WebhookListResponseSchema

from deel_python_sdk.type.webhook_list_response import WebhookListResponse
from deel_python_sdk.type.api_error_container import ApiErrorContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.webhook_list_response import WebhookListResponse as WebhookListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WebhookListResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_webhook_subscriptions_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_webhook_subscriptions_oapg(
        self,
    ...
    def _list_webhook_subscriptions_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class ListWebhookSubscriptionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_webhook_subscriptions(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_webhook_subscriptions_mapped_args(
        )
        return await self._alist_webhook_subscriptions_oapg(
            **kwargs,
        )
    ...
    def list_webhook_subscriptions(
        ...
        return self._list_webhook_subscriptions_oapg(
        )

class ListWebhookSubscriptions(BaseApi):

    async def alist_webhook_subscriptions(
        self,
        validate: bool = False,
        **kwargs,
    ) -> WebhookListResponsePydantic:
        raw_response = await self.raw.alist_webhook_subscriptions(
            **kwargs,
        )
        if validate:
            return WebhookListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhookListResponsePydantic, raw_response.body)
    ...
    def list_webhook_subscriptions(
        ...
        raw_response = self.raw.list_webhook_subscriptions(
        )
        if validate:
            return WebhookListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhookListResponsePydantic, raw_response.body)
