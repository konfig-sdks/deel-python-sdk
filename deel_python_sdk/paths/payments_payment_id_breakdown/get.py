...
from deel_python_sdk.model.payment_break_down_container import PaymentBreakDownContainer as PaymentBreakDownContainerSchema

from deel_python_sdk.type.payment_break_down_container import PaymentBreakDownContainer
from deel_python_sdk.type.api_error_container import ApiErrorContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.payment_break_down_container import PaymentBreakDownContainer as PaymentBreakDownContainerPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'payment_id': typing.Union[PaymentIdSchema, str, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = PaymentBreakDownContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaymentBreakDownContainer
...
class BaseApi(api_client.Api):
    ...
    def _get_payment_breakdown_mapped_args(
        self,
        payment_id: str,
    ...
    async def _aget_payment_breakdown_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/payments/{payment_id}/breakdown',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_payment_breakdown_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetPaymentBreakdownRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_payment_breakdown(
        self,
        payment_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_payment_breakdown_mapped_args(
            payment_id=payment_id,
        )
        return await self._aget_payment_breakdown_oapg(
    ...
    def get_payment_breakdown(
        ...
        return self._get_payment_breakdown_oapg(
            path_params=args.path,
        )

class GetPaymentBreakdown(BaseApi):
    ...
    async def aget_payment_breakdown(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaymentBreakDownContainerPydantic:
        raw_response = await self.raw.aget_payment_breakdown(
            payment_id=payment_id,
            **kwargs,
        )
        if validate:
            return PaymentBreakDownContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(PaymentBreakDownContainerPydantic, raw_response.body)
    ...
    def get_payment_breakdown(
        ...
        raw_response = self.raw.get_payment_breakdown(
            payment_id=payment_id,
        )
        if validate:
            return PaymentBreakDownContainerPydantic(**raw_response.body)
