...
from deel_python_sdk.model.organization_list_container import OrganizationListContainer as OrganizationListContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.organization_list_container import OrganizationListContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.organization_list_container import OrganizationListContainer as OrganizationListContainerPydantic
from deel_python_sdk.pydantic.api_error_container import ApiErrorContainer as ApiErrorContainerPydantic

SchemaFor200ResponseBodyApplicationJson = OrganizationListContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OrganizationListContainer
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrganizationListContainerPydantic:
        raw_response = await self.raw.aget_details(
            **kwargs,
        )
        if validate:
            return OrganizationListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(OrganizationListContainerPydantic, raw_response.body)
