...
from deel_python_sdk.model.adjustments_container import AdjustmentsContainer as AdjustmentsContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.adjustments_container import AdjustmentsContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.adjustments_container import AdjustmentsContainer as AdjustmentsContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = AdjustmentsContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AdjustmentsContainer
    ...
    async def _aget_all_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/contracts/{contract_id}/adjustments',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return AdjustmentsContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(AdjustmentsContainerPydantic, raw_response.body)
