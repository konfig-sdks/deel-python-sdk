...
from deel_python_sdk.model.additional_eor_info_container import AdditionalEORInfoContainer as AdditionalEORInfoContainerSchema
...
from deel_python_sdk.type.additional_eor_info_container import AdditionalEORInfoContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.generic_result_updated import GenericResultUpdated as GenericResultUpdatedPydantic
from deel_python_sdk.pydantic.additional_eor_info_container import AdditionalEORInfoContainer as AdditionalEORInfoContainerPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AdditionalEORInfoContainerSchema


request_body_additional_eor_info_container = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = GenericResultUpdatedSchema
...
class BaseApi(api_client.Api):
    ...
    def _add_additional_information_for_eor_employee_mapped_args(
        self,
    ...
    async def _aadd_additional_information_for_eor_employee_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/partner-managed/employees/{employee_id}/contracts/{contract_id}/additional-information',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_additional_eor_info_container.serialize(body, content_type)
    ...
    def _add_additional_information_for_eor_employee_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AddAdditionalInformationForEorEmployeeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_additional_information_for_eor_employee(
        self,
        data: typing.Union[bool, date, datetime, dict, float, int, list, str, None],
        employee_id: str,
        contract_id: str,
        **kwargs,
        ...
        args = self._add_additional_information_for_eor_employee_mapped_args(
            data=data,
            employee_id=employee_id,
            contract_id=contract_id,
        )
        return await self._aadd_additional_information_for_eor_employee_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def add_additional_information_for_eor_employee(
        self,
        data: typing.Union[bool, date, datetime, dict, float, int, list, str, None],
        employee_id: str,
        contract_id: str,
        ...
        return self._add_additional_information_for_eor_employee_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddAdditionalInformationForEorEmployee(BaseApi):
    ...
    async def aadd_additional_information_for_eor_employee(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_additional_information_for_eor_employee(
            data=data,
            employee_id=employee_id,
            contract_id=contract_id,
            **kwargs,
    ...
    def add_additional_information_for_eor_employee(
        ...
        raw_response = self.raw.add_additional_information_for_eor_employee(
            data=data,
            employee_id=employee_id,
            contract_id=contract_id,
        )
