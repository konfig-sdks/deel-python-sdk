...
from deel_python_sdk.model.country_list_container import CountryListContainer as CountryListContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.country_list_container import CountryListContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.country_list_container import CountryListContainer as CountryListContainerPydantic
...
SchemaFor200ResponseBodyApplicationJson = CountryListContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CountryListContainer
...
class BaseApi(api_client.Api):
    ...
    def _get_country_list_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_country_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lookups/countries',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetCountryListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_country_list(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_country_list_mapped_args(
        )
        return await self._aget_country_list_oapg(
            **kwargs,
        )
...
class GetCountryList(BaseApi):
    ...
    async def aget_country_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CountryListContainerPydantic:
        raw_response = await self.raw.aget_country_list(
            **kwargs,
        )
        if validate:
            return CountryListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(CountryListContainerPydantic, raw_response.body)
    ...
    def get_country_list(
        ...
        raw_response = self.raw.get_country_list(
        )
        if validate:
            return CountryListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(CountryListContainerPydantic, raw_response.body)
