...
SchemaFor200ResponseBodyApplicationJson = ContractContainerSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_single_contract_mapped_args(
        self,
        contract_id: str,
    ...
    async def _aget_single_contract_oapg(
        self,
...
class GetSingleContractRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single_contract(
        self,
        contract_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_single_contract_mapped_args(
            contract_id=contract_id,
        )
        return await self._aget_single_contract_oapg(
    ...
    def get_single_contract(
        ...
        return self._get_single_contract_oapg(
            path_params=args.path,
        )

class GetSingleContract(BaseApi):
    ...
    async def aget_single_contract(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_single_contract(
            contract_id=contract_id,
            **kwargs,
        )
        if validate:
    ...
    def get_single_contract(
        ...
        raw_response = self.raw.get_single_contract(
            contract_id=contract_id,
        )
        if validate:
            return ContractContainerPydantic(**raw_response.body)
