...
from deel_python_sdk.model.timeoff_type_list_container import TimeoffTypeListContainer as TimeoffTypeListContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.timeoff_type_list_container import TimeoffTypeListContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.timeoff_type_list_container import TimeoffTypeListContainer as TimeoffTypeListContainerPydantic
from deel_python_sdk.pydantic.api_error_container import ApiErrorContainer as ApiErrorContainerPydantic

SchemaFor200ResponseBodyApplicationJson = TimeoffTypeListContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TimeoffTypeListContainer
...
class BaseApi(api_client.Api):
    ...
    def _get_time_off_types_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_time_off_types_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lookups/time-off-types',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetTimeOffTypesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_time_off_types(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_time_off_types_mapped_args(
        )
        return await self._aget_time_off_types_oapg(
            **kwargs,
        )
    ...
    def get_time_off_types(
        ...
        return self._get_time_off_types_oapg(
        )

class GetTimeOffTypes(BaseApi):

    async def aget_time_off_types(
        self,
        validate: bool = False,
        **kwargs,
    ) -> TimeoffTypeListContainerPydantic:
        raw_response = await self.raw.aget_time_off_types(
            **kwargs,
        )
        if validate:
            return TimeoffTypeListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(TimeoffTypeListContainerPydantic, raw_response.body)
    ...
    def get_time_off_types(
        ...
        raw_response = self.raw.get_time_off_types(
        )
        if validate:
            return TimeoffTypeListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(TimeoffTypeListContainerPydantic, raw_response.body)
