...
from deel_python_sdk.model.currency_list_container import CurrencyListContainer as CurrencyListContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.currency_list_container import CurrencyListContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.currency_list_container import CurrencyListContainer as CurrencyListContainerPydantic
from deel_python_sdk.pydantic.api_error_container import ApiErrorContainer as ApiErrorContainerPydantic

SchemaFor200ResponseBodyApplicationJson = CurrencyListContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CurrencyListContainer
...
class BaseApi(api_client.Api):
    ...
    def _get_currencies_list_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_currencies_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lookups/currencies',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetCurrenciesListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_currencies_list(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_currencies_list_mapped_args(
        )
        return await self._aget_currencies_list_oapg(
            **kwargs,
        )
    ...
    def get_currencies_list(
        ...
        return self._get_currencies_list_oapg(
        )

class GetCurrenciesList(BaseApi):

    async def aget_currencies_list(
        self,
        validate: bool = False,
        **kwargs,
    ) -> CurrencyListContainerPydantic:
        raw_response = await self.raw.aget_currencies_list(
            **kwargs,
        )
        if validate:
            return CurrencyListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(CurrencyListContainerPydantic, raw_response.body)
    ...
    def get_currencies_list(
        ...
        raw_response = self.raw.get_currencies_list(
        )
        if validate:
            return CurrencyListContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(CurrencyListContainerPydantic, raw_response.body)
