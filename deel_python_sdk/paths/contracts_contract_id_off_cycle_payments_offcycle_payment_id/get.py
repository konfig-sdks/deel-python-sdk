...
from deel_python_sdk.model.off_cycle_payment_container import OffCyclePaymentContainer as OffCyclePaymentContainerSchema

from deel_python_sdk.type.api_error_container import ApiErrorContainer
from deel_python_sdk.type.off_cycle_payment_container import OffCyclePaymentContainer

from ...api_client import Dictionary
from deel_python_sdk.pydantic.off_cycle_payment_container import OffCyclePaymentContainer as OffCyclePaymentContainerPydantic
...
OffcyclePaymentIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'contract_id': typing.Union[ContractIdSchema, str, ],
        'offcycle_payment_id': typing.Union[OffcyclePaymentIdSchema, str, ],
    }
)
...
request_path_offcycle_payment_id = api_client.PathParameter(
    name="offcycle_payment_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=OffcyclePaymentIdSchema,
    required=True,
)
_auth = [
    'deelToken',
...
SchemaFor200ResponseBodyApplicationJson = OffCyclePaymentContainerSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OffCyclePaymentContainer
...
class BaseApi(api_client.Api):
    ...
    def _get_single_payment_mapped_args(
        self,
        contract_id: str,
        offcycle_payment_id: str,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        if contract_id is not None:
            _path_params["contract_id"] = contract_id
        if offcycle_payment_id is not None:
            _path_params["offcycle_payment_id"] = offcycle_payment_id
        args.path = _path_params
        return args

    async def _aget_single_payment_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_path_offcycle_payment_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/contracts/{contract_id}/off-cycle-payments/{offcycle_payment_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetSinglePaymentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single_payment(
        self,
        contract_id: str,
        offcycle_payment_id: str,
        **kwargs,
        ...
        args = self._get_single_payment_mapped_args(
            contract_id=contract_id,
            offcycle_payment_id=offcycle_payment_id,
        )
        return await self._aget_single_payment_oapg(
    ...
    def get_single_payment(
        ...
        return self._get_single_payment_oapg(
            path_params=args.path,
        )

class GetSinglePayment(BaseApi):
    ...
    async def aget_single_payment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OffCyclePaymentContainerPydantic:
        raw_response = await self.raw.aget_single_payment(
            contract_id=contract_id,
            offcycle_payment_id=offcycle_payment_id,
            **kwargs,
        )
        if validate:
            return OffCyclePaymentContainerPydantic(**raw_response.body)
        return api_client.construct_model_instance(OffCyclePaymentContainerPydantic, raw_response.body)
    ...
    def get_single_payment(
        ...
        raw_response = self.raw.get_single_payment(
            contract_id=contract_id,
            offcycle_payment_id=offcycle_payment_id,
        )
        if validate:
