...
from deel_python_sdk.model.alternate_email_list import AlternateEmailList as AlternateEmailListSchema
...
from deel_python_sdk.pydantic.alternate_email_list import AlternateEmailList as AlternateEmailListPydantic
...
SchemaFor200ResponseBodyApplicationJson = AlternateEmailListSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AlternateEmailList
...
class BaseApi(api_client.Api):
    ...
    def _find_emails_by_id_mapped_args(
        self,
        contract_id: str,
    ...
    async def _afind_emails_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/contracts/{contract_id}/alternate_emails',
            auth_settings=_auth,
            headers=_headers,
        )
...
class FindEmailsByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afind_emails_by_id(
        self,
        contract_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._find_emails_by_id_mapped_args(
            contract_id=contract_id,
        )
        return await self._afind_emails_by_id_oapg(
    ...
    def find_emails_by_id(
        ...
        return self._find_emails_by_id_oapg(
            path_params=args.path,
        )

class FindEmailsById(BaseApi):
    ...
    async def afind_emails_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AlternateEmailListPydantic:
        raw_response = await self.raw.afind_emails_by_id(
            contract_id=contract_id,
            **kwargs,
        )
        if validate:
            return RootModel[AlternateEmailListPydantic](raw_response.body).root
        return api_client.construct_model_instance(AlternateEmailListPydantic, raw_response.body)
    ...
    def find_emails_by_id(
        ...
        raw_response = self.raw.find_emails_by_id(
            contract_id=contract_id,
        )
        if validate:
            return RootModel[AlternateEmailListPydantic](raw_response.body).root
